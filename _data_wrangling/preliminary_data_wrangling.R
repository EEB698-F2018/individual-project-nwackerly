...
setwd("C:/Users/nw185_000/Documents/Iowa/Dissertation/Data/individual-project-nwackerly/_data")

#read in preliminary data
preliminary_data <- read_csv("preliminary_data.csv")
...
preliminary_data$pos_beh <- as.character(preliminary_data$pos_beh)
preliminary_data$context <- as.character(preliminary_data$context)
preliminary_data$substrate <- as.character(preliminary_data$substrate)
preliminary_data$hab_type <- as.character(preliminary_data$hab_type)
preliminary_data$sun <- as.character(preliminary_data$sun)
preliminary_data$temp <- as.character(preliminary_data$temp)
preliminary_data$t_lo <- as.character(preliminary_data$t_lo)
preliminary_data$t_hi <- as.character(preliminary_data$t_hi)
...
preliminary_data$temp[preliminary_data$temp == "Os"] <- "NA"
...
preliminary_data$pos_beh <- as.factor(as.character(preliminary_data$pos_beh))
preliminary_data$context <- as.factor(as.character(preliminary_data$context))
preliminary_data$substrate <- as.factor(as.character(preliminary_data$substrate))
preliminary_data$hab_type <- as.factor(as.character(preliminary_data$hab_type))
preliminary_data$individual <- as.factor(as.character(preliminary_data$individual))
preliminary_data$sun <- as.numeric(as.character(preliminary_data$sun))
preliminary_data$temp <- as.numeric(as.character(preliminary_data$temp))
preliminary_data$t_lo <- as.numeric(as.character(preliminary_data$t_lo))
preliminary_data$t_hi <- as.numeric(as.character(preliminary_data$t_hi))
preliminary_data$date <- as.Date(as.character(preliminary_data$date))


###################################################################################

#create tidy database for analysis
write.csv(preliminary_data, "C:/Users/nw185_000/Documents/Iowa/Dissertation/Data/individual-project-nwackerly/_data/_tidy/prelim_data_tidycols.csv", row.names=F)
